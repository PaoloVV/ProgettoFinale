  ...
  return (
    <div className="arctic flex flex-col justify-start">
      ...
      <div className="description-arctic">
        ...
        <p className="text-sm">
          Sea level is a very sensitive indicator of climate change. Global
          warming in fact results in the thermal expansion of the oceans and the
          increase in the flow of fresh water into the sea due to the melting of
          glaciers and ice caps. The entry of fresh water into the oceans
          produces a further effect on sea level: it reduces the salinity and
          therefore the density of sea water, with effects on ocean circulation
          that are reflected in how sea level varies from region to region.
        </p>
      </div>
